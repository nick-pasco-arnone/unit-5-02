// Created on: November 20
// Created by: Nicholas.Pasco-Arnone
// Created for: ICS3U
// This program will calculate the bigest of 10 generated numbers
...
class ViewController : UIViewController {
    ...
    override func viewDidLoad() {
        ...
        instructionsLabel.text = "Click the button to generate ten random numbers between 0 and 100 and find the bigest."
        ...
        addButton.setTitle("Find bigest number", for: UIControl.State.normal)
